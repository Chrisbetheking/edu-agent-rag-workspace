...
export class ToolsController {
  ...
  private async withQuota<T>(
    ...
    const quota = consume
      ? this.authContext.consumeGuestQuota(user)
      : this.authContext.quotaFor(user);
  ...
  recommend(
    ...
    return this.withQuota(authorization, () =>
      this.tools.recommendSchools(body),
    );
  }
  ...
  copywriting(
    ...
    return this.withQuota(authorization, () =>
      this.tools.generateCopywriting(body),
    );
  }
  ...
  applicationPlan(
    ...
    return this.withQuota(authorization, () =>
      this.tools.applicationPlan(body),
    );
  }
